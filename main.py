...
class View_sim(QtGui.QWidget):        
    def __init__(self, parent):
        ...
        #************************** SELECT SIMULATION  *******************************
        #*****************************************************************************
        self.select_lbl = QtGui.QLabel('Select Simulation----->', self)
        ...
        self.rarifier = QtGui.QLineEdit("1")
        self.rarifier_lbl = QtGui.QLabel('% Cells to View', self)
        ...
        self.query_string = QtGui.QLineEdit("ei=='excitatory'")
        self.query_button = QtGui.QPushButton('Load Query')
        ...
        self.view_button = QtGui.QPushButton('View Query (opengl)')
        self.view_button.setFont(QtGui.QFont("Times", 12, QtGui.QFont.Bold) )
        self.view_button.setStyleSheet('color: blue')
        
        self.view_button.clicked.connect(self.vw_query_3D)
        #self.view_button.clicked.connect(self.vw_query)
        layout.addWidget(self.view_button, row_index, 0)
        

        self.view_button = QtGui.QPushButton('View Query (mpl)')
        self.view_button.setFont(QtGui.QFont("Times", 12, QtGui.QFont.Bold) )
        self.view_button.setStyleSheet('color: blue')
        
        #self.view_button.clicked.connect(self.vw_query_3D)
        self.view_button.clicked.connect(self.vw_query)
        layout.addWidget(self.view_button, row_index, 4)
    ...
    #Old visualization functions
    def vw_query(self):
        self.parent.simulation.load_query(self)
        self.parent.simulation.show_query()
        
        
    def vw_query_3D(self):
        self.parent.simulation.load_query(self)
        self.parent.simulation.show_query_3D(self)
